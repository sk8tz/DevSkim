...
exports.SARIF21ResultWriter = void 0;
const DevSkimObjects = require("../../../devskimObjects");
const pathOperations_1 = require("../../pathOperations");
 ...
 */
class SARIF21ResultWriter extends outputWriter_1.DevSkimResultsWriter {
    /**
    ...
    */
    ...
    createRun(analysisRun) {
        let runNumber = this.SarifFileObject.runs.length;
        ...
        this.SarifFileObject.runs[runNumber].originalUriBaseIds = { "%SRCROOT%": { "uri": new pathOperations_1.PathOperations().fileToURI(analysisRun.directoryInfo.directoryPath) } };
    ...
    addRules(rules, runNumber) {
        ...
        const _rules = rules.sort((a, b) => a.id.localeCompare(b.id));
        for (let rule of _rules) {
            ...
            if ((rule.severity != "best-practice" || this.devskimSettings.enableBestPracticeRules) &&
                ...
                let newSarifRule = Object.create(null);
                ...
                switch (rule.severity) {
                    ...
                    case "important":
                    case "moderate":
                        newSarifRule.defaultConfiguration = { "level": "error" };
                        break;
     ...
     */
    addFiles(files, runNumber) {
        if (this.SarifFileObject.runs.length < runNumber) {
            throw "Run Object for this run has not yet been created";
        }
        this.SarifFileObject.runs[runNumber].artifacts = [];
        for (let file of files) {
            let sarifFile = Object.create(null);
     ...
     */
    addResults(problems, directory, runNumber) {
        if (this.SarifFileObject.runs.length < runNumber) {
            throw "Run Object for this run has not yet been created";
        }
        this.SarifFileObject.runs[runNumber].results = [];
        let pathOp = new pathOperations_1.PathOperations();
        for (let problem of problems) {
            let sarifResult = Object.create(null);
            ...
            switch (problem.severity) {
                ...
                case DevSkimObjects.DevskimRuleSeverity.Moderate:
...
exports.SARIF21ResultWriter = SARIF21ResultWriter;
//# sourceMappingURL=sarif21Writer.js.map